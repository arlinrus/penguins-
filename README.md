...
![download](https://github.com/arlinrus/penguins-/assets/111064731/553ee3b5-0cc5-4136-9f6e-1e24e9d5bfd6)

По графику можем заметить сильную корееляцию, но для того, чтобы убедиться в этом проведем следующие исследованияя. 

Праверим данные с помощью теста Шапиро Уилка 
