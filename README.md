...
island - остров, где находятся определенная порода пингвина 

bill_length_mm - длина клюва пингвина (непрерывные колличественные)

bill_depth_mm - глубина ключа пингвина (непрерывные колличественные)

flipper_length_mm - длина крыла пингвина (непрерывные колличественные)

body_mass_g - масса тела пингвина (непрерывные колличественные)

sex - пол пингвина 

year - возраст пингвина
